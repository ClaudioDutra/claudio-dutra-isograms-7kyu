...
describe("function isIsogram", () => {
  ...
  test.each(["Dermatoglyphics", "a", "isogram"])(
    "should return true when the word has no repeating letter (%s)",
    (isogram) => {
  ...
  test.each(["aba", "MoOse", "isIsogram"])(
    "should return false when the word has repeating letter (%s)",
    (notIsogram) => {
